...
const ExperimentContainer: React.FC = () => {
    ...
    if (view === 'questionnaire') return <Questionnaire onSubmit={actions.handleQuestSubmit} />;
    ...
    // Tutor widoczny dla wszystkich w fazie Learning
    const showTutor = currentTrial?.phase === 'learning';
